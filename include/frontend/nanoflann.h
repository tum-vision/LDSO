#pragma once
#ifndef LDSO_NANO_FLANN_H_
#define LDSO_NANO_FLANN_H_
...
#define NANOFLANN_VERSION 0x119
    ...
    struct L1_Adaptor {
        ...
        inline DistanceType
        operator()(const T *a, const size_t b_idx, size_t size, DistanceType worst_dist = -1) const {
